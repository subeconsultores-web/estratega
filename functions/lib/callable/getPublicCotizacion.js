...
exports.getPublicCotizacion = void 0;
const functions = require("firebase-functions/v2");
const admin = require("firebase-admin");
exports.getPublicCotizacion = functions.https.onCall(async (request) => {
    const { id } = request.data;
    if (!id) {
        throw new functions.https.HttpsError('invalid-argument', 'Se requiere el ID de la cotización.');
    }
    try {
        ...
        if (clientSnap.exists) {
            clientName = clientSnap.data().nombreEmpresa;
        }
...
//# sourceMappingURL=getPublicCotizacion.js.map