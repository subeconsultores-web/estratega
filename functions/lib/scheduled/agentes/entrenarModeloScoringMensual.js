...
exports.entrenarModeloScoringMensual = void 0;
const scheduler_1 = require("firebase-functions/v2/scheduler");
const admin = require("firebase-admin");
exports.entrenarModeloScoringMensual = (0, scheduler_1.onSchedule)({
                ...
                if (p.clienteId) {
                    ...
                    if (cDoc.exists) {
                        ...
                        perfilesIdeales.push({
                            giro: cData === null || cData === void 0 ? void 0 : cData['giro'],
                            scoreHistorico: cData === null || cData === void 0 ? void 0 : cData['score'],
                            sitioWeb: (cData === null || cData === void 0 ? void 0 : cData['sitioWeb']) ? true : false,
                        });
                    }
                }
            }
...
//# sourceMappingURL=entrenarModeloScoringMensual.js.map