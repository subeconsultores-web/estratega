...
exports.onClienteUpdateLeadScore = void 0;
const firestore_1 = require("firebase-functions/v2/firestore");
const admin = require("firebase-admin");
exports.onClienteUpdateLeadScore = (0, firestore_1.onDocumentUpdated)("clientes/{clienteId}", async (event) => {
    ...
    try {
        ...
        const perfilIdeal = tenantData === null || tenantData === void 0 ? void 0 : tenantData['perfilIdealAI'];
        ...
        if (perfilIdeal && perfilIdeal.rasgosComunes && perfilIdeal.rasgosComunes.length > 0) {
            ...
            const girosExitosos = rasgos.map((r) => r.giro).filter(Boolean);
            ...
            const sitiosExitosos = rasgos.filter((r) => r.sitioWeb).length;
...
//# sourceMappingURL=onClienteUpdateLeadScore.js.map