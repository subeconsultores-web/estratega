...
exports.onCotizacionCreated = void 0;
const functions = require("firebase-functions/v2");
const admin = require("firebase-admin");
// Trigger que simula un "Transaccional/Atómico" para inyectar correlativo a cotizaciones
exports.onCotizacionCreated = functions.firestore.onDocumentCreated('cotizaciones/{docId}', async (event) => {
...
//# sourceMappingURL=onCotizacionCreated.js.map